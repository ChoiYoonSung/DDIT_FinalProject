...
<body class="pace-done pace-top">
	...
	<div id="app" class="app">
		<div class="register register-with-news-feed">
			<div class="register-container" style="margin: 0px;width: 100%;">
				...
				<div class="register-content row">
					<div class="mb-3 col-8">
						<label class="mb-2" onclick="fillForm();">QNA 제목</label>
						<div class="row gx-3">
							<div class="col-md-12 mb-2 mb-md-0">
								<input type="text" class="form-control fs-13px" placeholder="제목을 입력하세요" name="qnaTitle">
							</div>
						</div>
					</div>
					...
					<div class="mb-3 col-12">
						...
						<div class="row gx-3">
							<div class="col-md-12 mb-2 mb-md-0">
								<textarea class="form-control fs-13px" name="qnaContent" style="height: 140px; resize: none;" placeholder="내용을 입력하세요"></textarea>
							</div>
						</div>
					</div>
			...
			<div class="mb-3 app-content col-12">
				<div class="row">
					<div class="col-6">
						<a type="button" onclick="qnaRegist_go();"
							class="btn btn-primary d-block w-100 btn-lg h-45px fs-13px">등록</a>
					</div>
					<div class="col-6">
	...
	<script>
	function fillForm(){
		$('input[name="qnaTitle"]').val("프로젝트를 등록 관련 문의입니다.");
		$('textarea[name="qnaContent"]').val("등록과 동시에 PL을 넘길순 없나요?");
	}
	
	function qnaRegist_go(){
		...
		$.ajax({
			url:"<%=request.getContextPath()%>/center/qna/qnaRegister.do",
			type:"POST",
			data:param,
