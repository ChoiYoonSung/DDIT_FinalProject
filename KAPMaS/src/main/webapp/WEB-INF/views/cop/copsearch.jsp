			...
			<div class="col-xl-12 ui-sortable">
				...
				<div class="panel panel-inverse" data-sortable-id="ui-media-object-1"
					...
					<div class="panel-heading ui-sortable-handle">
						...
						<a onclick="javascript:OpenWindow('<%=request.getContextPath()%>/cop/makecop.do', 'makeCop', '900', '750')" class="btn btn-primary" data-bs-toggle="modal">COP 개설</a>
					</div>
													...
													<thead>
														<tr role="row">
															...
															<th width="10%" style="width: 70px;" class="text-nowrap sorting sorting_desc" tabindex="0"
																...
																aria-label=": activate to sort column ascending"
																aria-sort="descending">설명</th>
															<th width="5%" class="text-nowrap sorting" tabindex="0"
																aria-controls="data-table-combine" rowspan="1"
																colspan="1" data-column-index="4"
																aria-label="Browser: activate to sort column ascending">소유자</th>
															<th width="5%" class="text-nowrap sorting" tabindex="0"
																aria-controls="data-table-combine" rowspan="1"
																colspan="1" data-column-index="5"
																aria-label="Platform(s): activate to sort column ascending">개설일</th>
														</tr>
													</thead>
													<tbody>
