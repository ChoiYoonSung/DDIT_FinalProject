												...
												<thead>
													<tr role="row">
														...
														<th width="5%" data-orderable="false"
															...
															style="width: 22px;" data-column-index="1" aria-label="">토론방명</th>
														...
														<th class="text-nowrap sorting sorting_desc" tabindex="0"
															...
															aria-label=": activate to sort column ascending"
															aria-sort="descending">토론방 소유자</th>
															
													</tr>
												</thead>
												<tbody>
													<c:forEach var="jdl" items="${discussionList}">
														<tr
															onclick="OpenWindow('detail/${jdl.copCode}','${jdl.copName}','1440','800');"
