...
<body style="background-color: #dee2e6;">
	<div class="row" style="margin: 0px;">
		<div class="col-xl-12 ui-sortable">
			...
			<h1 class="page-header">참여중 Cop</h1>
										...
										<div class="row">
											<table id="data-table-combine"
												...
												<tbody>
													...
													<c:forEach var="jcv" items="${joinCopVO}" begin="0"
														end="${fn:length(joinCopVO)}" varStatus="status">
														<tr
															onclick="OpenWindow('detail/${jcv.copCode}','${jcv.copName}','1130','700');"
