		...
		<div id="content">
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col-md-3" style="margin-right: 0; float: right; text-align: right;">
						<button type="button" id="removeBtn" class="btn btn-danger"	onclick="history.back()">뒤로가기</button>
						<button type="button" id="listBtn" class="btn btn-primary"	onclick="javascript:window.close();">닫기</button>
					</div> 
				</div>		
			<div class="search-banner" style="padding: 0px;">

				<div class="container" style="text-align: center; padding-top: 30px">
					<h1 style="color: black; padding-bottom: 30px">자료 검색</h1>
					<div class="input-group" style="margin: 0 auto; width: 800px;">
						<input type="text" class="form-control form-control-lg" id="addKW"	placeholder="검색할 키워드를 입력하고 추가버튼을 클릭하세요">
