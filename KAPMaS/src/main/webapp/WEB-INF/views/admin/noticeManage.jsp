		...
		<div class="col-xl-12 ui-sortable">
			<div class="panel panel-inverse"
				...
				<div class="panel-heading">
					<h4 class="panel-title">공지 게시글</h4>
					<a onclick="location.href='<%=request.getContextPath() %>/admin/noticeRegistForm'" class="btn btn-gray">공지사항 등록</a>
					&nbsp;&nbsp;&nbsp;
										...
										<div class="row">
											<table id="data-table-combine" class="table table-striped table-bordered align-middle">
												...
												<c:forEach var="notice" items="${noticeList }">
													<tr onclick="location.href='<%=request.getContextPath() %>/admin/noticeDetail/${notice.noticeNo }'">
