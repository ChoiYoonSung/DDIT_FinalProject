		...
		<div class="col-xl-12 ui-sortable">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-media-object-1"
				...
				<div class="panel-heading ui-sortable-handle">
					<h4 class="panel-title">패밀리 제명</h4>
				</div>
							...
							<div class="panel-body">
								<form method="post" action="exileFamily.do" name="registForm">
									...
									<div class="row">
										...
										<div class="col-6">
											<input type="hidden" class="form-control" id="sender" name="sender" value="${loginUser }" readonly="readonly"/>
									...
									<div style="width:210px;  margin:0 auto; margin-top: 30px;">
										<button type="button" class="btn btn-danger w-100px me-5px" id="registBtn" onclick="exileMember_go();">제명</button>
