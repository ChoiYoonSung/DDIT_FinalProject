...
public class MenuServiceImpl implements MenuService {
	...
	@Override
	public List<MenuVO> getThirdSubMenuList(String mCode) throws SQLException {
		List<MenuVO> thirdMenuList = null;
		
		thirdMenuList = menuDAO.selectThirdSubMenu(mCode);
	...
	@Override
	public MenuVO getMenuByMlevel(int mLevel) throws SQLException {
		MenuVO menu = null;
		
		menu = menuDAO.selectMenuByMlevel(mLevel);
		return menu;
	}
