...
public class EmpController {
	...
	public String modify(EmpModifyCommand modifyReq,HttpSession session,Model model) throws Exception{
		String url = "emp/modify_success";
		...
		model.addAttribute("emp", empService.getEmpById(modifyReq.getEmpId()));
