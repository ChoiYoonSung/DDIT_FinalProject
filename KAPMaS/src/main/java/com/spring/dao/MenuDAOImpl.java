...
public class MenuDAOImpl implements MenuDAO {
	...
	@Override
	public List<MenuVO> selectThirdSubMenu(String mCode) {
		List<MenuVO> menuList = session.selectList("Menu-Mapper.selectThirdSubMenu",mCode);
		return menuList;
	}
	...
	@Override
	public MenuVO selectMenuByMlevel(int mLevel) throws SQLException {
		MenuVO menu = session.selectOne("Menu-Mapper.selectMenuByMlevel",mLevel);
		return menu;
	}
