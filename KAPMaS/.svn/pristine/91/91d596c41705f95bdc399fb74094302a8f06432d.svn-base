			...
			<div class="login-container">
				...
				<div class="login-body">
					...
					<div class="login-content fs-13px">
						<form action="<%=request.getContextPath() %>/emp/regist.do" method="post">
							
							<div class="form-floating mb-20px">
								<input type="text" class="form-control fs-13px h-45px" name="empName" id="empName" placeholder="UserName" />
								<label for="empName" class="d-flex align-items-center py-0">이름|</label>
							</div>
							<div class="form-floating mb-20px">
							...
							<div class="form-floating mb-20px">
								<select style="width:400px;" name="dep" id="dep" >
							...
							<div class="form-floating mb-20px">
								<select style="width:400px;" name="rank" id="rank" >
							...
							<div class="login-buttons" style="float: left;">
								<button type="submit" class="btn h-45px btn-yellow d-block w-80 btn-lg"  style="float: left;">Sign up</button>
